...
public class App {
	...
	public static void main(String[] args) {
		...
		for (String havKey : Shared.haveKeys) {
			logger.debug("HAVE KEY: " + havKey);
		}
		for (String noKey : Shared.haveNotKeys) {
			logger.debug("NOT HAVE KEY: " + noKey);
		}
...
//		}
	...
	private static void initKeys(Integer nodeID, Config conf)
